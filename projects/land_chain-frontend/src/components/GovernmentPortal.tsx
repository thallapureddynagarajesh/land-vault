          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-2xl font-bold text-stone-800">Government Registrar Authority Portal</h2>
              ...
              <p className="text-xs text-stone-400 mt-1">Review pending land title registrations, inspect IPFS deed CIDs, and approve or reject submissions on Algorand.</p>
            </div>
          </div>
