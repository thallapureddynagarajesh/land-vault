...
export const LandChainFooter: React.FC = () => {
  return (
    <footer className="mt-16 border-t border-slate-800/80 bg-slate-950/80 pt-12 pb-8 text-xs text-slate-400">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Architecture Specs */}
          <div>
            <h4 className="font-semibold text-slate-200 uppercase tracking-wider text-[11px] mb-3 flex items-center gap-1.5">
              <Cpu className="w-3.5 h-3.5 text-emerald-400" /> Blockchain Standard
            </h4>
          ...
          <div>
            <h4 className="font-semibold text-slate-200 uppercase tracking-wider text-[11px] mb-3 flex items-center gap-1.5">
              <Lock className="w-3.5 h-3.5 text-cyan-400" /> Trust & Compliance
            </h4>
          ...
          <div>
            <h4 className="font-semibold text-slate-200 uppercase tracking-wider text-[11px] mb-3 flex items-center gap-1.5">
              <Database className="w-3.5 h-3.5 text-amber-400" /> Resources
            </h4>
            <ul className="space-y-2 text-[11px] text-slate-400">
              <li>
                <a href="https://algorand.co" target="_blank" rel="noreferrer" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
                  <Globe className="w-3 h-3" /> Algorand Network
                </a>
              </li>
              <li>
                <a href="https://github.com/algorandfoundation/algokit-cli" target="_blank" rel="noreferrer" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
                  <Code2 className="w-3 h-3" /> AlgoKit Standard
                </a>
              </li>
              <li>
                <span className="text-slate-500">Smart Contract App ID: #10084920</span>
              </li>
            </ul>
          </div>
        </div>
